...
class TimingMiddleware:
    ...
    def process_resource(self, req, resp, resource, params):  # noqa: F841
        resp.set_header("ReceptionTimestamp", str(datetime.datetime.now().timestamp()))

    def process_response(self, req, resp, resource, req_succeeded):  # noqa: F841
        ...
        if reception_header:
            ...
            self.__logger.info(
                f"Endpoint {resource.__class__.__name__}"
                f"(success={req_succeeded})={execution_time}s"
            )
